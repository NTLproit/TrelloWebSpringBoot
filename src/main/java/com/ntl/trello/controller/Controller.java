...
public class Controller {
    ...
    @RequestMapping(value = "/project", method = RequestMethod.POST, consumes ={MediaType.APPLICATION_JSON_UTF8_VALUE, MediaType.APPLICATION_FORM_URLENCODED_VALUE})
    public ResponseEntity<String> addProject(@Valid @RequestBody Project project){
        return new ResponseEntity<String>("Add sucsess", HttpStatus.OK);
    }
}
